...
# Defining, Labeling and creating buttons
...
mutliply = Button(frame, text='*', height=4, width=9, font=35,
                  command=lambda: button_press('*'))
mutliply.grid(row=2, column=3)
...
clear = Button(window, text='clear', height=4, width=36, font=35,
